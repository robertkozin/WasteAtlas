import { createDirectus, rest, staticToken, type RestCommand } from "@directus/sdk"
...
export function directusLoader<U extends Obj>(options: {
  ...
  return {
    ...
    load: async ({ collection, store, logger, parseData, meta, generateDigest }): Promise<void> => {
